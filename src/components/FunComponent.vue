...
<script>
    ...
    data(){
        ...
        methods: {
            ...
            addFoods(){
                for (let food of this.secrets){
                    document.querySelector(`article`).insertAdjacentHTML(`beforeend`, `<p>${food}</p>`)
                }
        ...
        mounted(){
            document.querySelector(`button`).addEventListener(`click`, this.backColor);
            this.addFoods();
        },
}
</script>
